...
const handleSubmit = async (e) => {
  ...
  if (isChatStarted == true) {
    inputExp = "Act as a resume writer and rewrite below experience in form of bullet points and include measurable results and also paraphrase it for " +  job +" :\n" + inputExp;
...
// Function to handle the up and down arrow keys
...
// Function to add the message to history
